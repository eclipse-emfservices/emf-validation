...
public class ConsoleUtil {
	...
	/**
	 * cache for 'console name' to 'default streams for error, warning and info for
	...
	public static void showConsole(String name) {
		...
		// API.
		// Expected: The API method should open the console view and display given the
		// console.
		// If the view is already open, it should be brought to the front.
		// Actual: if the view is not already open, the method opens it but does not
		// bring it
		// to front; A second invocation of the method is a workaround to bring to front
		// the
		// opened view.

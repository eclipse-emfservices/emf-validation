 ...
 * </copyright>
 *
 * $Id: ParameterImpl.java,v 1.1 2009/08/28 11:39:51 bgruschko Exp $
 */
...
public class ParameterImpl extends EObjectImpl implements BasicEMap.Entry<String,String> {
	...
	protected EClass eStaticClass() {
		return ValidationPackage.Literals.PARAMETER;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValidationPackage.PARAMETER__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValidationPackage.PARAMETER__VALUE, oldValue, value));
	}

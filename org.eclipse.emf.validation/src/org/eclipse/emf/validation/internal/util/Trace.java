...
/**
 * Delegates tracing duties to the
 * {@link EMFModelValidationPlugin.Tracing} class, with the
 * EMF Model Validation plug-in implicit in all traces and the option ID
 * also implicit in many cases.
 * 
...
public class Trace {
	...
	public static boolean shouldTrace(String option) {
		return EMFModelValidationPlugin.Tracing.shouldTrace(
				option);
	}
	...
	public static void trace(String message) {
		EMFModelValidationPlugin.Tracing.trace(
				message);
	}
	...
	public static void entering(
		...
		String methodName) {
			...
			EMFModelValidationPlugin.Tracing.entering(
				EMFModelValidationDebugOptions.METHODS_ENTERING,
				clazz,
				methodName);
	}
	...
	public static void exiting(
		...
		String methodName) {
			...
			EMFModelValidationPlugin.Tracing.exiting(
				EMFModelValidationDebugOptions.METHODS_EXITING,
				clazz,
				methodName);
	}
	...
	public static void catching(
		...
		Throwable throwable) {
			...
			EMFModelValidationPlugin.Tracing.catching(
				EMFModelValidationDebugOptions.EXCEPTIONS_CATCHING,
				clazz,
				methodName,
				throwable);
	}
	...
	public static void throwing(
		...
		Throwable throwable) {
			...
			EMFModelValidationPlugin.Tracing.throwing(
				EMFModelValidationDebugOptions.EXCEPTIONS_THROWING,
				clazz,
				methodName,
				throwable);
	}

...
public class ConstraintsContentHandler extends DefaultHandler {
	 ...
	 */
	private class Stack {
		private final List<XmlConfigurationElement> contents = new java.util.ArrayList<XmlConfigurationElement>();
	...
	private static final class ResourceBundleCache {
		private final Map<Bundle, Map<String, ResourceBundle>> map = new java.util.HashMap<Bundle, Map<String, ResourceBundle>>();

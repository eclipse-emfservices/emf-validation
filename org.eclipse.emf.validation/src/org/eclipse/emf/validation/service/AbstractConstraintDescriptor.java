...
/**
 * <p>
 * A partial implementation of the {@link IConstraintDescriptor} interface that
...
public abstract class AbstractConstraintDescriptor implements IConstraintDescriptor {
	...
	private boolean isMandatory() {
		...
		for (Iterator<Category> iter = getCategories().iterator(); !result && iter.hasNext();) {
	...
	public void addCategory(Category category) {
		...
		if (categories.contains(defaultCategory)) {
			...
			ConstraintRegistry.getInstance().broadcastConstraintChangeEvent(
					new ConstraintChangeEvent(this, ConstraintChangeEventType.REMOVED_CATEGORY, defaultCategory));
		}
		...
		if (!categories.contains(category)) {
			...
			ConstraintRegistry.getInstance().broadcastConstraintChangeEvent(
					new ConstraintChangeEvent(this, ConstraintChangeEventType.ADDED_CATEGORY, category));
		}
	}
	...
	public void removeCategory(Category category) {
		if (categories.contains(category)) {
			...
			ConstraintRegistry.getInstance().broadcastConstraintChangeEvent(
					new ConstraintChangeEvent(this, ConstraintChangeEventType.REMOVED_CATEGORY, category));
		}
		...
		if (categories.isEmpty()) {
			...
			ConstraintRegistry.getInstance().broadcastConstraintChangeEvent(
					new ConstraintChangeEvent(this, ConstraintChangeEventType.ADDED_CATEGORY, defaultCategory));
		}
	}
	...
	public boolean equals(Object other) {
		return (other instanceof IConstraintDescriptor) && ((IConstraintDescriptor) other).getId().equals(getId());
	}

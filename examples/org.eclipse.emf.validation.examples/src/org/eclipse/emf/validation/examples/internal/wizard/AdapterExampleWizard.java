...
public class AdapterExampleWizard extends AbstractExampleWizard {
	...
	protected Collection<ProjectDescriptor> getProjectDescriptors() {
		...
		projects.add(new ProjectDescriptor("org.eclipse.emf.validation.examples", "zips/adapter.zip", //$NON-NLS-1$ //$NON-NLS-2$
				"org.eclipse.emf.validation.examples.adapter")); //$NON-NLS-1$

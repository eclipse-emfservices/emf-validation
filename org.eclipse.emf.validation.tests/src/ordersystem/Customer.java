...
public interface Customer extends EObject {
	 ...
	 * bidirectional and its opposite is '{@link ordersystem.OrderSystem#getCustomer
	 ...
	 * list. The list contents are of type {@link ordersystem.Account}. It is
	 * bidirectional and its opposite is '{@link ordersystem.Account#getOwner
	 * <em>Owner</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Account</em>' containment reference list isn't
	 ...
	 * The list contents are of type {@link ordersystem.Order}. It is bidirectional
	 * and its opposite is '{@link ordersystem.Order#getOwner <em>Owner</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Order</em>' containment reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 

...
public class ProductImpl extends EObjectImpl implements Product {
	...
	public void setOwner(OrderSystem newOwner) {
		if (newOwner != eInternalContainer()
			...
			if (newOwner != null)
				msgs = ((InternalEObject) newOwner).eInverseAdd(this, OrderSystemPackage.ORDER_SYSTEM__PRODUCT,
						OrderSystem.class, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrderSystemPackage.PRODUCT__OWNER, newOwner,
					newOwner));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case OrderSystemPackage.PRODUCT__OWNER:
			return eInternalContainer().eInverseRemove(this, OrderSystemPackage.ORDER_SYSTEM__PRODUCT,
					OrderSystem.class, msgs);
		}

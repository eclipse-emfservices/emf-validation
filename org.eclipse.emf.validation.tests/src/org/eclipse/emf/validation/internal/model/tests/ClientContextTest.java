...
public class ClientContextTest
	...
	public void test_initWithoutid() {
		...
		try {
			new ClientContext(new ConstraintDescriptorTest.FixtureElement(
	...
	public void test_initWithoutSelector() {
		try {
			new ClientContext(ConstraintDescriptorTest.FixtureElement.build(
				"clientContext", //$NON-NLS-1$
				new String[][] {
					{"id", "junit.testContext"}}));  //$NON-NLS-1$//$NON-NLS-2$
			fail("Should have thrown exception."); //$NON-NLS-1$
		} catch (CoreException e) {
			// success
		}
		...
		try {
			ConstraintDescriptorTest.FixtureElement element =
				ConstraintDescriptorTest.FixtureElement.build(
					...
					new String[][] {
						{"id", "junit.testContext"}});  //$NON-NLS-1$//$NON-NLS-2$
			element.addChild(new ConstraintDescriptorTest.FixtureElement(
				"enablement").addChild(new ConstraintDescriptorTest.FixtureElement( //$NON-NLS-1$
		...
		try {
			ConstraintDescriptorTest.FixtureElement element =
				ConstraintDescriptorTest.FixtureElement.build(
					...
					new String[][] {
						{"id", "junit.testContext"}});  //$NON-NLS-1$//$NON-NLS-2$
			element.addChild(ConstraintDescriptorTest.FixtureElement.build(
				"selector", //$NON-NLS-1$
				new String[][] {
					{"class", InvalidSelector.class.getName()}})); //$NON-NLS-1$
			new ClientContext(element);
			fail("Should have thrown exception."); //$NON-NLS-1$
		} catch (CoreException e) {
			// success
			...
			ConstraintDescriptorTest.FixtureElement element =
				ConstraintDescriptorTest.FixtureElement.build(
					...
					new String[][] {
						{"id", "junit.testContext"}});  //$NON-NLS-1$//$NON-NLS-2$
			element.addChild(new ConstraintDescriptorTest.FixtureElement(
				"enablement")).addChild(ConstraintDescriptorTest.FixtureElement.build( //$NON-NLS-1$
					"test", //$NON-NLS-1$
					new String[][] {
						{"property", "com.example.foo"}, //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void test_initWithValidSelector() {
		try {
			...
			element.addChild(ConstraintDescriptorTest.FixtureElement.build(
				"selector", //$NON-NLS-1$
				new String[][] {
					{"class", ValidSelector.class.getName()}})); //$NON-NLS-1$
			new ClientContext(element);
		} catch (CoreException e) {
			fail("Should not have thrown exception: " + e.getLocalizedMessage()); //$NON-NLS-1$
		}
	...
	public void test_initDefault() {
		try {
			...
			assertFalse(
				"Should not be default", //$NON-NLS-1$
	...
	public void test_equals() {
		try {
			...
			ConstraintDescriptorTest.FixtureElement element2 =
				ConstraintDescriptorTest.FixtureElement.build(
					"clientContext", //$NON-NLS-1$
					new String[][] {
						{"id", "junit.testContext2"}});  //$NON-NLS-1$//$NON-NLS-2$
			element2.addChild(new ConstraintDescriptorTest.FixtureElement(
				"enablement")); //$NON-NLS-1$

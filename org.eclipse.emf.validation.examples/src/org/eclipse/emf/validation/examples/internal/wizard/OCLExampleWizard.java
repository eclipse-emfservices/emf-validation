...
public class OCLExampleWizard extends AbstractExampleWizard {
	...
	protected Collection<ProjectDescriptor> getProjectDescriptors() {
		...
		projects.add(new ProjectDescriptor("org.eclipse.emf.validation.examples", "zips/ocl.zip", //$NON-NLS-1$ //$NON-NLS-2$
				"org.eclipse.emf.validation.examples.ocl")); //$NON-NLS-1$
